...
class PaymentPage {
  ...
  public readonly discount: Locator;
  ...
  constructor(page: Page, accountID?: number, type?: string) {
    ...
    this.discount = page.locator("div:nth-of-type(3) > div > div:nth-of-type(2) > span");
    ...
    this.spoilerButton = page.locator(
      "div:first-of-type>div>div>div>main>div>div>div>div>div:nth-of-type(2)>div>div:nth-of-type(2)>div"
    );
