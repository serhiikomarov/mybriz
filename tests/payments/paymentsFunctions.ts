...
export async function paymentCTVTest(page: any, browser: any, loginPage: LoginPage, mainPage: MainPage, paymentPage: PaymentPage, thankYouPage: ThankYouPage, paymentPageURL: string, userID: number, ctvAccountID: number, months: number) {
